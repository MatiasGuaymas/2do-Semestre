...
function cantAluImpares(a : arbol) : integer;
begin
	if(a = nil) then
		cantAluImpares:= 0
	else
		begin
			cantAluImpares:= cantAluImpares(a^.hi) + cantAluImpares(a^.hd);
...
begin
	...
	writeln('-------------------');
	writeln('La cantidad de alumnos con legajo impar es: ', cantAluImpares(a)); //E
